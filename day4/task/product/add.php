        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white">
            <div class="container-fluid p-0">
                ...
                <div class="navbar-nav ms-auto">
                    <a class="nav-link active" href="../product/add.php"> New Product </a>
                    <a class="nav-link" href="../product/myproduct.php" aria-current="page"> My product </a>
                </div>
        ...
        <div class="row g-3">
            ...
            <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" id="productAdd" enctype="multipart/form-data">
                <div class="col-md-6">
                    ...
                    <input type="text" name="product_name" id="product_name" class="form-control border-secondary">
                ...
                <div class="col-md-6">
                    ...
                    <textarea type="text" name="product_detail" id="product_detail" class="form-control  border-secondary"></textarea>
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" name="product_price" id="product_price" class="form-control border-secondary">
